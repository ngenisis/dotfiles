...
*** TODO Keybind to toggle dotfiles (dired-filter?)
*** TODO Try dired-subtree
...
*** TODO Disable trailing whitespace
...
*** TODO Equivalent of git/diff-highlight for Magit diff
...
*** TODO Don't move cursor when promoting or demoting in org mode
